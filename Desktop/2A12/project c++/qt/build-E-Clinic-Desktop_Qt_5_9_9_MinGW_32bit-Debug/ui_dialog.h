...
""));
        ...
        tabWidget_5->addTab(tab_13, icon1, QString());
        tab_14 = new QWidget();
...
"}"));
        ...
        tabWidget_5->addTab(tab_14, icon3, QString());
        tab_7 = new QWidget();
...
"}"));
        ...
        pushButtonSend->setStyleSheet(QLatin1String("QPushButton {\n"
"padding: 5px;\n"
"border-radius: 5px;\n"
"background-color:#0094ff;\n"
"font-weight: bold;\n"
...
"}"));
        ...
        tabWidget_5->addTab(tab_7, icon9, QString());
        tab_10 = new QWidget();
...
"}"));
        ...
        tabWidget_5->addTab(tab_10, icon4, QString());
        tab_11 = new QWidget();
...
"}"));
        ...
        tabWidget_5->addTab(tab_11, icon10, QString());
        QIcon icon11;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget_5->setTabText(tabWidget_5->indexOf(tab_13), QApplication::translate("MainWindow", "Ajouter factures/commandes", Q_NULLPTR));
        pushButton_2->setText(QString());
        tabWidget_5->setTabText(tabWidget_5->indexOf(tab_14), QApplication::translate("MainWindow", "Afficher factures/commandes", Q_NULLPTR));
